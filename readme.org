...
#+begin_src emacs-lisp
  ...
  (defun arki/desktop-remove (desktop-name)
    (interactive (list
                  (ido-completing-read "Remove this desktop:" (directory-files arki/desktop-dir nil "[^.]") nil t)))
    (when desktop-name
      (let ((cur-desktop-dir (expand-file-name desktop-name arki/desktop-dir)))
  ...
  (defun arki/desktop-read (&optional desktop-name)
    (interactive (list
                  (ido-completing-read "Read this desktop:" (directory-files arki/desktop-dir nil "[^.]") nil t)))
