...
(global-set-key (kbd "C-c u r") 'recentf-open-files)
...
;;配置org-mode中的快捷键
(global-set-key (kbd "C-c u a") 'org-agenda)
...
;; 选择当前行
(global-set-key (kbd "C-c u l") 'select-current-line)
...
;; 配置magit
(global-set-key (kbd "C-c u g") 'magit-status)
